<template>
    <div
        class="mx-auto mb-3 flex max-w-11/12 flex-col items-center justify-center bg-[#f3f3f3] sm:mx-3 sm:my-3 sm:mb-0 sm:max-w-10/12"
    >
        <!--header-->
        <div class="w-full">
            <div class="pb-1">
        ...
        <div class="grid w-full grid-cols-1 gap-8 lg:grid-cols-4">
                ...
                >
                    <nav class="flex flex-col">
                        ...
                        >
                            ...
                            <ChevronRight
                                v-if="activeRouteName === item.routeName"
            ...
            <main class="lg:col-span-3">
                <div class="rounded-lg border bg-[rgba(204,204,204,0.2)] p-6">
                    <RouterView />
                </div>
            </main>
        </div>
