            ...
            <div class="relative flex h-16 items-center justify-between">
                ...
                >
                    ...
                    >
                        ...
                        <span
                            class="absolute -top-1 -right-1 flex h-3 w-4 items-center justify-center rounded-full bg-white text-[9px] font-bold text-black"
                        >
                            3
                        </span>
                    </button>
                    ...
                    >
                        <span class="absolute -inset-1.5" />
                        <span class="sr-only">View notifications</span>
                        <ShoppingBagIcon aria-hidden="true" class="size-6" />
                        <span
                            class="absolute -top-1 -right-1 flex h-3 w-4 items-center justify-center rounded-full bg-white text-[9px] font-bold text-black"
                        >
                            3
                    ...
                    >
                        <span class="absolute -inset-1.5" />
                        <span class="sr-only">View notifications</span>
                        <UserIcon aria-hidden="true" class="size-6" />
                    </button>
                </div>
            </div>
        </div>
            ...
            <div class="flex flex-col space-y-3 px-4 pt-2 pb-3">
                <RouterLink
                    ...
                    :class="[
                        ...
                        'cursor-pointer border-white font-sans text-sm',
                    ]"
                    :href="item.href"
                    :to="item.to"
                        ...
                        <RouterLink
                            ...
                            :class="[
                                isActive(item)
                                    ? 'border-b-1 text-white'
                                    : 'text-white hover:border-b-1',
                                'border-white font-sans text-sm',
                            ]"
                            :to="item.to"
                            >{{ item.name }}</RouterLink
                        >
